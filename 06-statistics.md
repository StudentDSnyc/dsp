...
>>Let p(T) = p(male twins) = p(fraternal male twins) + p(identical male twins) = (1/4) (1/125) + (1/2) (1/300)  
    p(I) = (1/300)  
    p(T|I) = p(male twins | identical twins) = (1/2)  
    
>>Substituting in Baye's Theorem:  
p(T) p(I|T) = p(I) p(T|I)  
p(I|T) = [p(I) p(T|I)] / p(T)  
**p(I) = 5/11**  
